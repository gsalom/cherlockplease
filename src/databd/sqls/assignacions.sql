...
SELECT c.nom, o.nom, concat(a.llin1," ",a.llin2,", ",a.nom) as assignat, o.estat, o.comentaris FROM cherlock.ordinadors o, cherlock.carretons c, cherlock.alumnat a where o.carreto=c.id_car and c.id_car=8 and o.assignacio=a.codi;
